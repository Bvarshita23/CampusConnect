...
export default function AdminDashboard() {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const data = await res.json();
      if (!res.ok) return alert(`⚠️ ${data.message}`);
        ...
        >
          ...
          >
            ...
            >
              ...
              <p className="text-white/80 text-sm">Manage lost items</p>
            </motion.div>
